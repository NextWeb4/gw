...
当前 v0.2.1 Windows x64 安装包已在本机完成构建和解包版启动冒烟，移动底栏遮挡修复也已通过 390×844 几何与可视化回归；[GitHub Pages 演示版](https://nextweb4.github.io/hxhwang-gw/) 已由 [Pages Actions run 30147717322](https://github.com/NextWeb4/hxhwang-gw/actions/runs/30147717322) 正式部署。[v0.2.1](https://github.com/NextWeb4/hxhwang-gw/releases/tag/v0.2.1) 已由 [Release Actions run 30148327399](https://github.com/NextWeb4/hxhwang-gw/actions/runs/30148327399) 构建 Windows/Linux x64、arm64，并通过 Debian 10/12 的 x64/arm64 四组合安装启动门；Release 包含六个安装产物及 `SHA256SUMS.txt`，清单中的六个校验值均与 GitHub 资产摘要一致。真实 arm64 设备和 Authenticode 签名仍是明确的外部验证项，不应标记为已完成。
