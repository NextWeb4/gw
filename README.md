...
当前 v0.2.1 Windows x64 安装包已在本机完成构建和解包版启动冒烟，移动底栏遮挡修复也已通过 390×844 几何与可视化回归；远端正式版本仍为 [v0.2.0](https://github.com/NextWeb4/hxhwang-gw/releases/tag/v0.2.0)，由 [Release Actions run 30111552737](https://github.com/NextWeb4/hxhwang-gw/actions/runs/30111552737) 构建 Windows/Linux x64、arm64，并通过 Debian 10/12 的 x64/arm64 四组合安装启动门。v0.2.1 推送与标签工作流完成前，不把本地验证写成远端已发布。真实 arm64 设备和 Authenticode 签名仍是明确的外部验证项，不应标记为已完成。
