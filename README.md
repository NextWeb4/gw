...
![Version](https://img.shields.io/badge/version-0.7.27-0969da?style=flat-square)
...
The current release is `0.7.27`. The workbench can copy a deterministic daily briefing derived from the same active records and date buckets as the local work focus. See [`RELEASE_NOTES.md`](RELEASE_NOTES.md) for details.
...
The repository version is `0.7.27`. Dependencies are locked by `pnpm-lock.yaml`; use the frozen lockfile for reproducible installs.
