...
function LedgerViewControls({ label, placeholder, countLabel, visibleCount, totalCount, view, filterOptions, sortOptions, onViewChange, onReset }: {
  label: string; placeholder: string; countLabel: string; visibleCount: number; totalCount: number; view: LedgerViewState;
  filterOptions: readonly LedgerViewOption[]; sortOptions: readonly LedgerViewOption[]; onViewChange: (patch: Partial<LedgerViewState>) => void; onReset: () => void;
}) {
