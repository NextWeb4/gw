...
| Windows v0.2.0 本机构建 | `pnpm build:desktop:win:x64`、解包程序启动冒烟 | x64 已通过 | `HxHwang-Gw-0.2.0-x64-setup.exe` 为 100,950,072 字节，SHA-256 `B88546A7874CAB44650E951DF1267E3F587A69C5B8C305764E4B5AE0D3432445`；解包程序启动后观察到 4 个进程并全部退出。arm64/Linux 正式产物等待 `v0.2.0` 标签的 Actions 矩阵，不提前标记完成 |
